...
#ifndef FIND_NEW_CORNER_SUB_H  // <- This should be changed to your own guard on both
#define FIND_NEW_CORNER_SUB_H  //    of these lines
 ...
 * PUBLIC TYPEDEFS                                                             *
 ******************************************************************************/
static uint8_t StartFindNewCorner;
