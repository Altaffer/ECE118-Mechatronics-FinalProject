...
#ifndef TO_BEACON_SUB_H  // <- This should be changed to your own guard on both
#define TO_BEACON_SUB_H  //    of these lines
...
ES_Event RunToBeacon(ES_Event ThisEvent);
